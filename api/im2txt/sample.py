...
hidden_size = 512
num_layers = 1
encoder_path = '{}/models/encoder-10-1000.ckpt'.format(settings.IM2TXT_DATA)
decoder_path = '{}/models/decoder-10-1000.ckpt'.format(settings.IM2TXT_DATA)
vocab_path = '{}/data/vocab.pkl'.format(settings.IM2TXT_DATA)
